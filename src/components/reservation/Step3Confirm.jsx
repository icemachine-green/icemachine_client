  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      const finalData = {
        ...
        serviceStartTime: selection.serviceStartTime.includes(":") ? selection.serviceStartTime : selection.serviceStartTime + ":00",
      ...
      <div className="confirm-card">
        ...
        <div className="confirm-section">
          ...
          <div className="confirm-value">
            ...
            <span>{businessDetail?.mainAddress} {businessDetail?.detailedAddress}</span>
          </div>
        </div>
        ...
        <div className="confirm-section total">
          ...
          <div className="confirm-value">
            <strong className="price-text">{selectedPolicy?.price ? selectedPolicy.price.toLocaleString() : "0"} 원</strong>
        ...
        {isImmediateNoCancel() && (
          <div className="policy-warning-box">
            ...
            <p className="warning-desc">
              현재 선택하신 일시는 서비스 시작까지 <strong>24시간 미만</strong>으로 남았습니다. 
              확정 후에는 <strong>단순 변심으로 인한 취소가 불가능</strong>하오니 신중히 결정해 주세요.
            </p>
          </div>
        )}
      </div>
